---
id: TASK-039
title: Validate focus-window bonus rules
type: task
status: open
priority: medium
tier: 2
...
# TASK-039: Validate focus-window bonus rules

## Goal

Complete the refinement pass for Validate focus-window bonus rules as part of the fully fledged physical fastest-clicker experience.
