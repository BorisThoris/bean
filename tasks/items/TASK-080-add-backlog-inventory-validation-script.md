---
id: TASK-080
title: Add backlog inventory validation script
type: task
status: done
priority: high
tier: 2
...
# TASK-080: Add backlog inventory validation script

## Goal

Complete the refinement pass for Add backlog inventory validation script as part of the fully fledged physical fastest-clicker experience.
