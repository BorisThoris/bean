---
id: TASK-048
title: Polish spectator state messaging
type: task
status: open
priority: medium
tier: 3
...
# TASK-048: Polish spectator state messaging

## Goal

Complete the refinement pass for Polish spectator state messaging as part of the fully fledged physical fastest-clicker experience.
