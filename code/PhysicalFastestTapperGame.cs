...
public sealed partial class PhysicalFastestTapperGame : Component, Component.INetworkListener
{
	...
	[Property] public string PixelGrassFloorMaterialPath { get; set; } = "materials/floor/pixel_grass_floor.vmat";
	[Property] public float PixelGrassFloorHeightAboveFloor { get; set; } = 5f;
	[Property] public Color PixelGrassFloorTint { get; set; } = Color.White;
	...
	private Model PixelGrassFloorModel;
	private float PixelGrassFloorModelWidth;
	private float PixelGrassFloorModelDepth;
	private string PixelGrassFloorModelMaterialPath;
	private GameObject PixelGrassFloorObject;
	private ModelRenderer PixelGrassFloorRenderer;
